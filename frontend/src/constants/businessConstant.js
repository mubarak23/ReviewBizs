...
export const BUSINESS_LISTS_REQUEST = "BUSINESS_LISTS_REQUEST";
export const BUSINESS_LISTS_SUCCESS = "BUSINESS_LISTS_SUCCESS";
export const BUSINESS_LISTS_FAIL = "BUSINESS_LISTS_FAIL";
